...
MESSAGE_MAP = {
    ...
    "refresh success": "登录状态刷新成功",
    "refresh token invalid": "登录状态已失效，请重新登录",
    "logout success": "退出登录成功",
    "old password incorrect": "原密码不正确",
    "new password too short": "新密码长度不能少于 6 位",
    ...
    "dashboard statistics found": "总览看板数据获取成功",
    "logs found": "日志列表获取成功",
...
MESSAGE_PATTERNS = (
    ...
    ("Qwen chat response", "通义千问对话返回内容异常，请稍后重试"),
    ("Embedding response", "向量检索服务返回内容异常，请稍后重试"),
    ("Invalid embedding", "向量检索结果格式异常，请稍后重试"),
    ...
    ("prompt is required", "请填写提示词内容"),
    ("messages is required", "请填写消息内容"),
    ...
    ("geocode response", "经纬度服务返回内容异常，请稍后重试"),
